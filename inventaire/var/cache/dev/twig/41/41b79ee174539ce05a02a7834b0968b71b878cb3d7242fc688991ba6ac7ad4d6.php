...
class __TwigTemplate_ac9778008471d95dadaedc4269f4afc546118d35984638db3d1c9c4d1bfa9638 extends Template
{
    private $source;
    private $macros = [];
...
<?php if (\$required): ?> required=\"required\"<?php endif ?>
<?php echo \$attr ? ' '.\$view['form']->block(\$form, 'attributes') : '' ?>", "@Framework/Form/widget_attributes.html.php", "/usr/src/app/inventaire/vendor/symfony/framework-bundle/Resources/views/Form/widget_attributes.html.php");
    }
}
